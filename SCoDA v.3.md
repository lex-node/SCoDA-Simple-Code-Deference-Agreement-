...
(iii) Prohibition of Legal Proceedings & Transfers. Each Party shall not,
...
(ii) Exception Standstill. During the period commencing upon the earlier of a
...
(ii) Other than the representations and warranties of the other Party expressly
...
(b) “Claim” means any past, present or future
dispute, claim, controversy, demand, right, obligation, liability, action or
cause of action of any kind or nature. 

(c) “Confirmation” of a transaction shall
...
(d) “Consensus Attack” means an attack that: (i) is undertaken by or
...
(e) “Consensus Rules” means the rules for transaction validity,
...
(g) “Designated Blockchain” means at any give time, the
version of the digital blockchain ledger commonly known as “[Ethereum]” that at
least a majority of nodes running the Designated Client recognize as canonical
...
has been “forked” or “split”. 

(h) “Designated Blockchain Network” means the
Ethereum mainnet (networkID:1, chainID:1), as recognized by the Designated
Client. 

(i) “Designated Client” means the Official Go Ethereum client available
at https://github.com/ethereum/go-ethereum. 

(j) “Designated Smart Contract”
means the smart contract deployed at address [____________] on the Designated
Blockchain. 

(k) “Designated Token” means any amount equal to or greater than one
Wei (i.e., one-quintillionth) of the Token commonly known as “PETH” exchanged on
the Designated Blockchain. 

(l) “Legal Order” means any restraining order,
...
(m) “Legal Proceeding” means any private or governmental action,
...
(o) “Material Adverse Exception Event” means that one or more
of the following has occurred, is occurring or would reasonably be expected to
occur:  

(i) a Consensus Attack adversely affecting the results or operations of
the Designated Smart Contract;  

(ii) the Designated Smart Contract having become
...
itself suffered a Material Adverse Exception Event, mutatis mutandis;  
...
results in a loss to a party to this Agreement of at least ___ percent
...
(g) Disputes; Mandatory Arbitration. Any Legal Proceeding, Claim or other
